            ...
            <section className="profileSetting">
                ...
                <section className="profileSetting-content">
                 <ul class="list-group">
                    ...
                    <li class="list-group-item"><Link to={`/customer/showProfile`}> مشاهده پروفایل</Link></li>
                    <li class="list-group-item"><Link to={`/customer/editProfile`}>  ویرایش پروفایل  </Link></li>
